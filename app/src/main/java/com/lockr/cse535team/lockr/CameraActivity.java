    ...
    Camera.PictureCallback mPictureCallback = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            if (data != null) {
                ...
                m.setBody("Someone attempted to access your device ");
                try {
                    m.addAttachment(Environment.getExternalStorageDirectory() + File.separator + "test1.jpg");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                m.setFrom(fromEmail);
                try {
                    ...
                    if (m.send()) {
                        ...
                        Toast.makeText(CameraActivity.this, "Email was sent successfully.", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(CameraActivity.this, "Email was not sent.", Toast.LENGTH_LONG).show();
                    }
