...
public class ApplicationAdapter extends ArrayAdapter<ApplicationInfo> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        boolean tgpref = sharedPreferences.getBoolean("name:"+applicationInfo.packageName.toString(), false);  //default is true
        if (tgpref)
        {
        ...
        toggleButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b){
                    ...
                    editor.putBoolean("name:"+applicationInfo.packageName.toString(), true);
                    editor.apply();
                }else{
                    Log.d(TAG, "onClick: Package name is:" + applicationInfo.packageName);
                    apps.remove(applicationInfo.packageName.toString());
                    SharedPreferences.Editor editor = sharedPreferences.edit();
                    editor.putBoolean("name:"+applicationInfo.packageName.toString(), false);
                    editor.apply();
                }
